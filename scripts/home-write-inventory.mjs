...
export const HOME_WRITE_INVENTORY = Object.freeze([
  ...
  outside('cli/record-removal.mjs', 'rm', 1, 'Raw removal taken only after writer.assertOutside proves the target is beyond the home (Claude host files, Codex rules, legacy records and logs).'),
