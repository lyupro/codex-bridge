...
`@lyupro/codex-bridge` installs four Claude Code dispatcher agents (`codex-scout`, `codex-build`,
`codex-review`, `codex-advisor`), a delegating runner and seven guard hooks into a Claude Code host, so
